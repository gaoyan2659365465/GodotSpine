...
func 创建文字图标():
	...
	tex.texture = preload("res://资源/图片.svg")
	...
	tex2.texture = preload("res://资源/选项卡_复制.svg")
	...
	tex4.texture = preload("res://资源/颜色.svg")
...
func 创建CheckBox():
	...
	add_child(勾选)
	勾选.position = Vector2(90,28)
	勾选.size = Vector2(60,25)
	
	var 勾选2 = CheckBox.new()
	勾选2.text = "导出"
	勾选2.set("theme_override_constants/h_separation",4)
	勾选2.set("theme_override_constants/check_v_offset",1)
	勾选2.set("theme_override_font_sizes/font_size",12)
	勾选2.focus_mode = Control.FOCUS_NONE
	add_child(勾选2)
	勾选2.position = Vector2(144,28)
	勾选2.size = Vector2(60,25)
	
	var 勾选3 = CheckBox.new()
	勾选3.text = "名称"
	勾选3.set("theme_override_constants/h_separation",4)
	勾选3.set("theme_override_constants/check_v_offset",1)
	勾选3.set("theme_override_font_sizes/font_size",12)
	勾选3.focus_mode = Control.FOCUS_NONE
	add_child(勾选3)
	勾选3.position = Vector2(200,28)
	勾选3.size = Vector2(60,25)
	
	var 勾选4 = CheckBox.new()
	勾选4.text = "网格"
	勾选4.set("theme_override_constants/h_separation",4)
	勾选4.set("theme_override_constants/check_v_offset",1)
	勾选4.set("theme_override_font_sizes/font_size",12)
	勾选4.focus_mode = Control.FOCUS_NONE
	add_child(勾选4)
	勾选4.position = Vector2(90,28+27)
	勾选4.size = Vector2(60,25)

	
func 创建ColorPickerButton():
	var 颜色 = ColorPickerButton.new()
	颜色.position = Vector2(90,86)
